...
enum FolderSource {
    ...
    **접힌 줄이 글에 맞춰 서는지** 보는 자리입니다 (155). 아래 둘째 항목은 한 줄에
    안 들어가서 다음 줄로 넘어갑니다 — 넘어간 줄이 **윗줄의 첫 글자 아래**에 서야
    합니다. 스크린샷에 긴 줄이 하나도 없어서 이 어긋남을 오래 못 봤습니다.

    1. 핵심역량, 경력기술(근거), 기여 요소 차례로 적기
    2. 첫 한 마디에서 이야기의 방향을 잡기
       1. 물음이 여기서 나오게 만드는 것이 핵심
       2. 문제정의-데이터확보-방법론검증-현장적용-운영이관
